...
const Todo = (props) => {
	let {tasks, addNewTask, removeTask, changeTask, changeTaskStatus, editMode,changeStatusTaskEditForm} = props;
		...
		<div className={s.todoWrapper}>
			<div className={s.todo}>
				...
				<div className={s.todoButtons}>
					<button className={s.todoBtnAdd} onClick={()=>{changeStatusTaskEditForm(true)}}>
				...
				<div className={s.allCount}>Отметить все</div>
